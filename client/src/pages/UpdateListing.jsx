...
export default function UpdateListing() {
  ...
  const handleSubmit = async (e) =>{
    ...
    try {
      ...
      if(+formData.regularPrice < +formData.discountPrice) return setError('Discount must be lower than the regular price!');
      setLoading(true);
      setError(false);
    ...
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <button disabled={loading || uploading} className="p-3 bg-black text-white rounded-lg uppercase hover:opacity-80 disabled:opacity-80">
